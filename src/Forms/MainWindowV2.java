 ...
 * @author Eldridge
 */
public class MainWindowV2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(ControlSlipButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 70, 370, 30));
        ...
        jPanel1.add(DyeingForm, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 280, 30));
        ...
        jPanel1.add(NewDyeingProgram, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 110, 85, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainWindowV2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainWindowV2().setVisible(true);
            }
        });
    }
    ...
    try {
        ...
        CodeSource codeSource = MainWindowV2.class.getProtectionDomain().getCodeSource();
