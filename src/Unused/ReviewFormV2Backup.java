 ...
 * @author Eldridge
 */
public class ReviewFormV2Backup extends javax.swing.JFrame {
    ...
    public ReviewFormV2Backup(JobOrderExtended currentJob, int setWindowType) {
        this();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviewFormV2Backup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReviewFormV2Backup().setVisible(true);
            }
        });
    }
